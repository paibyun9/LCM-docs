// tools/validator/tests/validate.test.js

const { execSync } = require("child_process");
const fs = require("fs");

// ✅ validate.js 실제 위치
const VALIDATE_CMD = "node tools/validator/validate.js tmp.input.json tmp.output.json";
...
function run(input, output) {
  ...
  return execSync(VALIDATE_CMD, { stdio: "pipe" }).toString();
}
